...
For FedProx, the centralized validation row IDs are read from the split file at
...
STRATEGY = "FedProx"
VALIDATION_SELECTION_SET = "centralized_validation"
...
def make_criterion(class_weights: torch.Tensor) -> nn.CrossEntropyLoss:
    """
    Weighted Cross-Entropy identical to the preceding FedProx validation evaluation.
