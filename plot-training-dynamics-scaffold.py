#!/usr/bin/env python3
"""
APA-Style SCAFFOLD Test-Set Training-Dynamics Figure
=====================================================
...
Panel B
    Linear test-AP trend per communication round over the final ten
    communication rounds.

Design
------
The figure follows the visual language of the supplied SCAFFOLD thesis plots:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Create an APA-style two-panel SCAFFOLD test-set "
...
def read_and_validate(
    ...
    if not path.is_file():
        raise FileNotFoundError(
            ...
            "Run evaluate-training-dynamics-scaffold.py first."
        )
...
def write_caption(output_dir: Path, ap_fraction: float) -> Path:
...
def main() -> None:
    ...
    print("=" * 82)
    print("APA-STYLE SCAFFOLD TEST-SET TRAINING-DYNAMICS FIGURE")
    ...
    caption_path = write_caption(args.output_dir, ap_fraction)
