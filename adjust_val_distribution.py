"""
Passt Val-Daten in splits_iid_2_clients.json an:
...
split_path = Path("splits_iid_scaling/splits_iid_2_clients.json")
...
output_path = Path("splits_iid_scaling/splits_iid_2_clients_adjusted.json")
...
print(f"   FROM: 'splits_iid_scaling/splits_iid_2_clients.json'")
print(f"   TO:   'splits_iid_scaling/splits_iid_2_clients_adjusted.json'")
