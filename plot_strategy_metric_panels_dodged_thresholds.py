...
def plot_family_panels(
    ...
    fig, (main_ax, threshold_ax) = plt.subplots(
        ...
        sharex=True,
        gridspec_kw={"height_ratios": [4.2, 1.15], "hspace": 0.08},
    )
    ...
    for offset, variant in zip(offsets, variants):
        ...
        # Keep the in-figure legend compact. Plateau statistics remain available
        # in the generated CSV files and can be reported in the text or caption.
    ...
    threshold_ax.grid(axis="x", which="major", alpha=0.10)
